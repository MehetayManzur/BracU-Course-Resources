...
<body>
    ...
    <div class="container">
        <a href="facultyinfo.php" class="cyber-button back-button">Back</a>
        <div class="scan-line"></div>
        <h1>Feedback System</h1>
        <div class="button-container">
            <a href="seefacultyfeedback.php" class="cyber-button">See Feedbacks</a>
            <a href="givefacultyfeedback.php" class="cyber-button">Give Feedback</a>
        </div>
    </div>
</body>
</html>