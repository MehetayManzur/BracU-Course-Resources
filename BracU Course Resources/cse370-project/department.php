...
<body>
    ...
    <div class="container">
        <div class="courses-box">
            ...
            <a href="signup.php" class="back-btn">Return</a>
            ...
            $sql = "SELECT dept_name,dco_mail,emergency_contact,ext_number FROM department"; 
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>Department_Name</th><th>Dco_Mail</th><th>Emergency_Contact</th><th>Ext_Number</th></tr>";
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                   
                    echo "<td>" . htmlspecialchars($row['dept_name']) . "</td>";
					echo "<td>" . htmlspecialchars($row['dco_mail']) . "</td>";
					echo "<td>" . htmlspecialchars($row['emergency_contact']) . "</td>";
					echo "<td>" . htmlspecialchars($row['ext_number']) . "</td>";
                    echo "</tr>";
                }
                echo "</table>";
            } else {
