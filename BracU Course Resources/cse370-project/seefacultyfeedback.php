...
<body>
    ...
    <div class="container">
        <div class="courses-box">
            ...
            <h1>Give Faculty Feedbacks</h1>
            
            <a href="facultyfeedback.php" class="back-btn">Return</a>
            ...
            $sql = "SELECT id,initial,comment FROM fac_feedback"; 
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>ID</th><th>Initial</th><th>Comment</th></tr>";
