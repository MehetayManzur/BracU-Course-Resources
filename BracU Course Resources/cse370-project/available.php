...
<body>
    ...
    <div class="container">
        <div class="courses-box">
            ...
            <a href="search.php" class="back-btn">Return to Search</a>
            ...
            $sql = "SELECT name, code FROM courses"; 
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>Course Name</th><th>Course Code</th></tr>";
                ...
                echo "<p class='no-data'>No courses available.</p>";
            }
