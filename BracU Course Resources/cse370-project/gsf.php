...
<body>
    ...
    <div class="container">
        <a href="signup.php" class="cyber-button back-button">Back</a>
        <div class="scan-line"></div>
        <h1>Feedback System</h1>
        <div class="button-container">
            <a href="seef.php" class="cyber-button">See Feedbacks</a>
            <a href="givf.php" class="cyber-button">Give Feedback</a>
        </div>
    </div>
</body>
</html>