<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (!empty($id) && !empty($initial) && !empty($comment)) {
            $sql = "INSERT INTO fac_feedback (id, initial, comment) VALUES ('$id', '$initial', '$comment')";
...
<head>
    ...
    <title>Submit Faculty Feedback</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <a href="seefacultyfeedback.php" class="back-button">Back</a>
        <div class="scan-line"></div>
        <h1>Submit Faculty Feedback</h1>
